<?php 
    ...
    if (isset($_GET['delete_id'])) {
        ...
        $stmt = $connForLogs->prepare("DELETE FROM admin_logs WHERE id = ?");
        $stmt->bind_param("i", $delete_id);
        $result = $stmt->execute();

        if ($result) {
            header("Location: admin_logs.php?message=delete_success");
            exit();
        } else {
            header("Location: admin_logs.php?message=delete_error");
            exit();
        }
    }
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class="active"><a href="admin_logs.php"><i class='bx bx-group'></i>My Logs</a></li>
        </ul>
        <ul class="side-menu">
            <li>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-bordered" style="width:100%">
                                ...
                                <tbody>
                                <?php
                                    $sql = "SELECT * FROM admin_logs WHERE userType = 'peso_admin' ORDER BY id DESC";
