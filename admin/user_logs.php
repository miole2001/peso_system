<?php 
    ...
    if (isset($_GET['delete_id'])) {
        ...
        $stmt = $connForLogs->prepare("DELETE FROM user_logs WHERE id = ?");
        $stmt->bind_param("i", $delete_id);
        $result = $stmt->execute();

        if ($result) {
            header("Location: user_logs.php?message=delete_success");
            exit();
        } else {
            header("Location: user_logs.php?message=delete_error");
            exit();
        }
    }
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class="active"><a href="user_logs.php"><i class='bx bx-group'></i>Applicant Logs</a></li>
            ...
            <div class="header">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        /
                        <li>
                            <a href="#" class="active">Applicant Logs</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div>
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        <h6 class="m-0 font-weight-bold text-primary">USER LOGS DATA</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <thead>
                                ...
                                <tbody>
                                <?php
                                    $sql = "SELECT * FROM user_logs WHERE userType = 'peso_user' ORDER BY id DESC";
                                    $result = $connForLogs->query($sql);
