...
<head>
    ...
    <title>PESO System | Job Approved Page</title>
</head>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class="active"><a href="job_approved.php"><i class='bx bx-message-square-dots'></i>Job Approved</a></li>
            ...
            <div class="header">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        /
                        <li>
                            <a href="#" class="active">Job Approved</a>
                        </li>
                    </ul>
                </div>
            </div>
